...
The CIO.gov site creates only a session cookie when you visit and destroys it as soon as you close your browser. There are no persistent cookies created on cio.gov. For more information on privacy and security, see GSA’s Privacy and Security Notice. If you have any questions about these policies, please contact us at [ciocouncil.support@gsa.gov](mailto:ciocouncil.support@gsa.gov).
